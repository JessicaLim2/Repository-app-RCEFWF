...
@EndUserText.label: 'Projection view of enhancement repo'
@UI.headerInfo: { typeName: 'Enhancement', typeNamePlural: 'Enhancement', 
         title: { type: #STANDARD } }
define root view entity ZC_ENHANCEMENT as projection on ZI_ENHANCEMENT as Enhancement
{
    @UI.facet: [
         {
               label : 'General',
...
//    @UI: {  lineItem:   [ { position: 1 , label: 'Technical Area' }]}
    ...
    @Consumption.valueHelpDefinition: [{ entity:{name: 'ZI_ENHANCEMENT_TECHSUBAREA_VH', 
...
//    uict_cpi_hide,
//    uict_rfc_hide,
    @UI: {  lineItem:       [ { position: 140, label: 'Enhancement Name' } ],
            fieldGroup: [{ position: 140, label:'Enhancement Name', qualifier: 'Detail' }],
            selectionField: [ { position: 140 }] }

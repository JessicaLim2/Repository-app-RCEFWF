...
@EndUserText.label: 'Projection view of report repository'
@UI.headerInfo: { typeName: 'Report', typeNamePlural: 'Report', 
         title: { type: #STANDARD } }
define root view entity ZC_REPORT as projection on ZI_REPORT as Report
{
    @UI.facet: [
         {
               label : 'General',
...
//    @UI: {  lineItem:   [ { position: 1 , label: 'Technical Area' }]}
    ...
    @Consumption.valueHelpDefinition: [{ entity:{name: 'ZI_REP_TECHSUBAREA_VH', 
...
//    uict_cpi_hide,
//    uict_rfc_hide,
    @UI: {  lineItem:       [ { position: 140, label: 'Report Name' } ],
            fieldGroup: [{ position: 140, label:'Report Name', qualifier: 'Detail' }],
            selectionField: [ { position: 140 }] }
